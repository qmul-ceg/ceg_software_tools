enum ErrorMessages   {
   ...
   EMISUnsuccessfulValidation = "This is not a valid EMIS Web report. Please try again.",

   //Parsing Errors
   EMISUnsuccessfulParsing = "This EMIS Web report could not be parsed. Please try again."
}
