...
const QuickFilters = ({handleQuickFilterSelection, selectedQuickFilter, quickFilters}: QuickFiltersPayload) => {
   return (
      <div className= " min-w-[400px] ">
         ...
         <div className="flex flex-col border-[0.1em] border-[#21376A]  border-t-0 p-2  ">
            {
               Object.entries(quickFilters).map(([key, value])=> {
                  ...
                  return(
                     <ul className="leading-tight">
                        <li>
                           <label htmlFor={value.id} className=" hover:opacity-90 font-medium text-sm  cursor-pointer">
                              <input 
