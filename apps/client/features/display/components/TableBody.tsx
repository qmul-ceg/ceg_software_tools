...
export default React.memo(TableBody)
 ...
 // <tr className= "hover:bg-gray-100">
                        //    {
                        //       // importedData?.data?.tableConfig?.map((data, index) => {
                        //       //    return (
                        //       //       data.id === "select"
...
// const filterFunctionalityObject = {
   ...
   // }, [filterStates.ageFilter, tableData])
   ...
   //    // setPatientCount(filterConfig!.length)
   // }, [filterConfig])
      ...
      // filterStates, // reportKeys,  setSelectedForExport, selectedForExport,
            // filteredData, setFilteredData, 
            // selectedPatientRow, 
            // setSelectedPatientRow, setSelectedPatientIndex, selectedPatientIndex, 


      // return tableData?.filter((row) => {
         
      //    // MOVE THESE ARE HELPER FUNCTIONS MOVE TO HELPER FILES
   ...
   // if(activeFilter in filterFunctionalityObject){
         //    tableData
         // }
